...
#include<locale.h>/*essa é uma biblioteca feita para permitir que use acentos nas frases em português*/

void main(){
setlocale(LC_ALL,"");//Permite usar acentos, faz com que o terminal use a lingua padrão do sistema se for em português irá permitir acentos.
int a=5;
